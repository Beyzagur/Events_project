<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="surname" value="{{ __('Soyad') }}" />
            ...
            <div>
                <x-jet-label for="telephone" value="{{ __('Telefon') }}" />
                <x-jet-input id="telephone" class="block mt-1 w-full" type="tel" name="telephone" :value="old('telephone')" required autofocus autocomplete="telephone" />
            </div>
            ...
            <div>
                <x-jet-label for="date_of_birth" value="{{ __('Doğum Tarihi') }}" />
